...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "c9c7be85f49f45a581ec00c309afda5c62ba9ef2"
  WORKING_DIRECTORY "/work/emscripten-build/_deps/zstd_lib-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "c9c7be85f49f45a581ec00c309afda5c62ba9ef2")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("c9c7be85f49f45a581ec00c309afda5c62ba9ef2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/c9c7be85f49f45a581ec00c309afda5c62ba9ef2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/work/emscripten-build/_deps/zstd_lib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/work/emscripten-build/_deps/zstd_lib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
