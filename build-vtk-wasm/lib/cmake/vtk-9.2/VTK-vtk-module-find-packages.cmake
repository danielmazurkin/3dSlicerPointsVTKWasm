...
if (_vtk_module_find_package_components)
  if ("RenderingWebGPU" IN_LIST _vtk_module_find_package_components)
    set(_vtk_module_find_package_enabled ON)
    if ("RenderingWebGPU" IN_LIST _vtk_module_find_package_components_required)
...
if (_vtk_module_find_package_enabled)
  ...
  find_package(SDL2
    ...
    COMPONENTS          
    OPTIONAL_COMPONENTS )
  if (NOT SDL2_FOUND AND _vtk_module_find_package_fail_if_not_found)
    if (NOT ${CMAKE_FIND_PACKAGE_NAME}_FIND_QUIETLY)
      message(STATUS
        "Could not find the ${CMAKE_FIND_PACKAGE_NAME} package due to a "
        "missing dependency: SDL2")
    endif ()
    set("${CMAKE_FIND_PACKAGE_NAME}_RenderingWebGPU_FOUND" 0)
    list(APPEND "${CMAKE_FIND_PACKAGE_NAME}_RenderingWebGPU_NOT_FOUND_MESSAGE"
      "Failed to find the SDL2 package.")
  endif ()
endif ()
