...
VTK_CREATE_CREATE_FUNCTION(vtkOpenGLES30PolyDataMapper)
VTK_CREATE_CREATE_FUNCTION(vtkOpenGLES30PolyDataMapper2D)
...
{
this->RegisterOverride("vtkPolyDataMapper", "vtkOpenGLES30PolyDataMapper", "Override for VTK::RenderingOpenGL2 module", 1, vtkObjectFactoryCreatevtkOpenGLES30PolyDataMapper);
this->RegisterOverride("vtkPolyDataMapper2D", "vtkOpenGLES30PolyDataMapper2D", "Override for VTK::RenderingOpenGL2 module", 1, vtkObjectFactoryCreatevtkOpenGLES30PolyDataMapper2D);
...
this->RegisterOverride("vtkRenderWindow", "vtkSDL2OpenGLRenderWindow", "Override for VTK::RenderingOpenGL2 module", 1, vtkObjectFactoryCreatevtkSDL2OpenGLRenderWindow);
